  ...
  return (
    <View className="flex-1 bg-white" style={{ paddingTop: insets.top }}>
      <View className="flex-row items-center justify-between px-4 mt-4 mb-2">
        ...
        <Text className="text-lg font-poppinsBold text-center flex-1 mr-10">
          Detail
        </Text>
      </View>
      ...
      >
        <View className="w-full h-48 mt-2 rounded-2xl overflow-hidden">
          <Image
            source={{
        ...
        {/* Like & Share Buttons to the left */}
        <View className="flex-row gap-4 my-4">
          ...
          <TouchableOpacity className="flex-row items-center space-x-2 bg-gray-200 rounded-full px-4 py-2">
            ...
            <Text className="text-gray-700 font-poppins ml-2">Share</Text>
          </TouchableOpacity>
        </View>
      ...
      {/* Take Quiz Button - fixed at bottom */}
      <View className="absolute bottom-12 left-4 right-4">
        <TouchableOpacity className="bg-purple-700 py-4 rounded-full items-center">
